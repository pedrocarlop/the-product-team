...
- **Registro de cambios** (`knowledge/log.md`): Log append-only de cada mutacion de conocimiento (`created`, `updated`, `superseded`, `archived`). Permite al orquestador ver que cambio desde el ultimo proyecto.
