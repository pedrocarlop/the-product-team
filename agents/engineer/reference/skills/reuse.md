...
- Restate the task in terms of this skill's trigger: When a task may already be covered by an existing pattern.
...
- If both primary and fallback paths fail, produce the best-guess output described as: A reuse recommendation with exact patterns to follow.
...
- Ensure the work meets this done-when bar: The preferred reusable pattern is explicit and justified.
