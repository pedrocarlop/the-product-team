...
- Restate the task in terms of this skill's trigger: When releases need better automation and control.
...
- If both primary and fallback paths fail, produce the best-guess output described as: A CI/CD governance proposal or implementation.
...
- Ensure the work meets this done-when bar: Delivery rules are concrete enough to enforce repeatedly.
