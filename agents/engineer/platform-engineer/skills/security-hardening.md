...
- Restate the task in terms of this skill's trigger: When the system needs a specific security fix or hardening step.
...
- If both primary and fallback paths fail, produce the best-guess output described as: A security hardening change or remediation plan.
...
- Ensure the work meets this done-when bar: The security issue and fix path are explicit.
