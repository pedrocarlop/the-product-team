...
- Restate the task in terms of this skill's trigger: When infra or deployment changes must be executed safely.
...
- If both primary and fallback paths fail, produce the best-guess output described as: An infra release plan or implementation summary.
...
- Ensure the work meets this done-when bar: The release path and rollback posture are explicit.
