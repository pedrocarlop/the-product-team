...
- Restate the task in terms of this skill's trigger: When data or actions must move across system boundaries.
...
- If both primary and fallback paths fail, produce the best-guess output described as: An integration implementation or flow design.
...
- Ensure the work meets this done-when bar: The integration path, failures, and key boundaries are explicit.
