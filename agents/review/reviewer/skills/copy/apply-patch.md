...
name: apply-patch
tool: apply_patch
description: Write the Reviewer plan and copy-review artifacts inside `/logs`.
---

# Apply Patch

Use this skill to write the Reviewer's plan and copy-review artifacts in `logs/active/<project-slug>/`. The review output should be structured, decisive, and easy for the orchestrator to route.

## When to Use

- After the reviewer has accepted ownership of the copy review pass and needs to write `plans/reviewer.md`
