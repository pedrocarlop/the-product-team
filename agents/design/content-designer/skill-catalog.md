...
- Output: logs/active/<project-slug>/deliverables/content-designer-content-review.md
...
- Output: logs/active/<project-slug>/deliverables/content-designer-conversation-and-guidance-design.md
...
- Output: logs/active/<project-slug>/deliverables/content-designer-error-empty-success-states.md
...
- Output: logs/active/<project-slug>/deliverables/content-designer-localization-prep.md
...
- Output: logs/active/<project-slug>/deliverables/content-designer-microcopy-flow-design.md
...
- Output: logs/active/<project-slug>/deliverables/content-designer-naming-and-taxonomy.md
