...
- Restate the task in terms of this skill's trigger: When reusable components need a clear system structure.
...
- If both primary and fallback paths fail, produce the best-guess output described as: An atomic component library plan or build description.
...
- Ensure the work meets this done-when bar: Atoms, molecules, organisms, and higher-level patterns are clearly organized.
