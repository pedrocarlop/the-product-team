...
- Output: knowledge/runs/<run-id>/design-systems-designer-atomic-library-build.md, knowledge/runs/<run-id>/assets/ (for visual artifacts)
...
- Output: knowledge/runs/<run-id>/design-systems-designer-component-governance.md, knowledge/runs/<run-id>/assets/ (for visual artifacts)
...
- Output: knowledge/runs/<run-id>/design-systems-designer-design-code-mapping.md, knowledge/runs/<run-id>/assets/ (for visual artifacts)
...
- Output: knowledge/runs/<run-id>/design-systems-designer-spacing-and-layout-scale.md, knowledge/runs/<run-id>/assets/ (for visual artifacts)
...
- Output: knowledge/runs/<run-id>/design-systems-designer-system-audit.md, knowledge/runs/<run-id>/assets/ (for visual artifacts)
...
- Output: knowledge/runs/<run-id>/design-systems-designer-system-qa-and-adoption.md, knowledge/runs/<run-id>/assets/ (for visual artifacts)
...
- Output: knowledge/runs/<run-id>/design-systems-designer-token-architecture.md, knowledge/runs/<run-id>/assets/ (for visual artifacts)
