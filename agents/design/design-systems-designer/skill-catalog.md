...
- Output: logs/active/<project-slug>/deliverables/design-systems-designer-atomic-library-build.md
...
- Output: logs/active/<project-slug>/deliverables/design-systems-designer-component-governance.md
...
- Output: logs/active/<project-slug>/deliverables/design-systems-designer-design-code-mapping.md
...
- Output: logs/active/<project-slug>/deliverables/design-systems-designer-spacing-and-layout-scale.md
...
- Output: logs/active/<project-slug>/deliverables/design-systems-designer-system-audit.md
...
- Output: logs/active/<project-slug>/deliverables/design-systems-designer-system-qa-and-adoption.md
...
- Output: logs/active/<project-slug>/deliverables/design-systems-designer-token-architecture.md
