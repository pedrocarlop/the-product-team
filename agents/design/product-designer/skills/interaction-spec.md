...
output_artifacts:
  - knowledge/product-designer-interaction-spec.md
...
- Produce a standalone deliverable at the path specified in the YAML `output_artifacts` (formatted as `knowledge/product-designer-interaction-spec.md`).
