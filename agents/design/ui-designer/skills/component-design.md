...
output_artifacts:
  - knowledge/runs/<run-id>/ui-designer-component-design.md
...
- Produce a standalone deliverable at the path specified in the YAML `output_artifacts` (formatted as `knowledge/ui-designer-component-design.md`).
