...
output_artifacts:
  - knowledge/ui-designer-responsive-and-state-spec.md
...
- Produce a standalone deliverable at the path specified in the YAML `output_artifacts` (formatted as `knowledge/ui-designer-responsive-and-state-spec.md`).
