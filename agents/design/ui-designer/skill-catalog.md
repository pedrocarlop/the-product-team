...
- Fallback: paper (production)
- Inspiration: stitch (reference browsing only)
...
- Primary MCP/tool: figma
- Fallback: paper (production), chrome_devtools, search_query, open
- Inspiration: stitch (reference browsing only)
...
- Primary MCP/tool: figma
- Fallback: paper (production/edit)
- Inspiration: stitch (reference browsing only)
...
- Primary MCP/tool: figma
- Fallback: paper (production/edit), chrome_devtools
- Inspiration: stitch (reference browsing only)
