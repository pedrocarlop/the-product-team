...
name: apply-patch
tool: apply_patch
description: Write the Requirements Reviewer plan and review artifacts inside `/logs`.
---

# Apply Patch

Use this skill to write the Requirements Reviewer's plan and review artifacts in `logs/active/<project-slug>/`. The review must be structured, decisive, and actionable.

## When to Use

- After the role has accepted reviewer ownership and needs to write `plans/requirements-reviewer.md`
...
- `logs/active/<project-slug>/plans/requirements-reviewer.md`
- `logs/active/<project-slug>/reviews/requirements-reviewer.md`
...
- **Action**: The specific change the Requirements Author must make
