...
- Restate the task in terms of this skill's trigger: When a market-facing message needs sharpening.
...
- If both primary and fallback paths fail, produce the best-guess output described as: A positioning brief with audience, alternatives, and message pillars.
...
- Ensure the work meets this done-when bar: The team can reuse the positioning consistently.
