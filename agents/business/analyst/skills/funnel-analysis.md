...
- Restate the task in terms of this skill's trigger: When conversion or progression performance is under question.
- Identify the required inputs, existing artifacts, and dependencies.
- Name the output this skill must produce.

### Step 3: Run The Tool Sequence
- Use the primary MCP/tool first: `repository, notion`.
- If the primary path is unavailable, blocked, out of credits, or missing setup, switch to `search_query, reference/trace`.
- If both primary and fallback paths fail, produce the best-guess output described as: A funnel analysis with major drop-offs and hypotheses.
...
- Ensure the work meets this done-when bar: The team knows where to focus and why.
