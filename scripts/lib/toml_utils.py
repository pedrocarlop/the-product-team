...
MANAGED_ROLE_TOMLS = (
    ...
    Path("agents/design/designer/designer.toml"),
    Path("agents/design/design-systems/design-systems.toml"),
    Path("agents/engineer/engineer/engineer.toml"),
    Path("agents/engineer/platform-engineer/platform-engineer.toml"),
    Path("agents/review/reviewer/reviewer.toml"),
