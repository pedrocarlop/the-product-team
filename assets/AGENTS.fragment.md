...
- Read installed role definitions in `.codex/agents/product-team-<discipline>/<role>/`. Each role has a `skill-catalog.md`; skills are at `.codex/agents/product-team-<discipline>/<role>/skills/<skill-name>.md` — construct the path, do not list the directory.
