...
```bash
python3 .antigravity/product-team/scripts/validate-install.py
```
...
```bash
python3 .antigravity/product-team/scripts/update-install.py
```
...
- `.antigravity/agents/product-team-<discipline>/<role>/<role>.toml`
- `.antigravity/agents/product-team-<discipline>/<role>/capabilities.md`
- `.antigravity/agents/product-team-<discipline>/<role>/skill-catalog.md`
- `.antigravity/agents/product-team-<discipline>/<role>/skills/*.md`
- `.antigravity/product-team/references/`
- `.antigravity/product-team/references/project-ds-spec-template.md`
- `.antigravity/product-team/references/reference-design-systems/`
- `.antigravity/product-team/scripts/validate-install.py`
- `.antigravity/product-team/scripts/update-install.py`
- `.antigravity/product-team/scripts/lib/`
- `.antigravity/product-team/manifest.json`
...
- ANTIGRAVITY.md contains a managed Product Team block that the installer keeps up to date.
...
- `.antigravity/product-team/manifest.json` records enough source metadata for installed repos to self-update later.
