...
output_artifacts: knowledge/orchestrator-log.md
...
### Step 4b: Update Knowledge Log
- If any knowledge deliverable was created, updated, ingested, queried, or linted, append an entry to `knowledge/log.md`:
  ```
