...
output_artifacts:
  - knowledge/runs/<run-id>/ux-researcher-study-ops-and-recruiting.md
...
- Produce a standalone deliverable at the path specified in the YAML `output_artifacts` (formatted as `knowledge/ux-researcher-study-ops-and-recruiting.md`).
