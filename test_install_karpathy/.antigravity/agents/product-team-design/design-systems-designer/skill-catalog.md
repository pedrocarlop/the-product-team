...
- Output: knowledge/design-systems-designer-atomic-library-build.md, knowledge/assets/ (for visual artifacts)
...
- Output: knowledge/design-systems-designer-component-governance.md, knowledge/assets/ (for visual artifacts)
...
- Output: knowledge/design-systems-designer-design-code-mapping.md, knowledge/assets/ (for visual artifacts)
...
- Output: knowledge/design-systems-designer-spacing-and-layout-scale.md, knowledge/assets/ (for visual artifacts)
...
- Output: knowledge/design-systems-designer-system-audit.md, knowledge/assets/ (for visual artifacts)
...
- Output: knowledge/design-systems-designer-system-qa-and-adoption.md, knowledge/assets/ (for visual artifacts)
...
- Output: knowledge/design-systems-designer-token-architecture.md, knowledge/assets/ (for visual artifacts)
