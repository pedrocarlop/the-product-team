...
- Output: knowledge/ui-designer-component-design.md, knowledge/assets/ (for visual artifacts)
...
- Output: knowledge/ui-designer-responsive-and-state-spec.md, knowledge/assets/ (for visual artifacts)
...
- Output: knowledge/ui-designer-screen-production-design.md, knowledge/assets/ (for visual artifacts)
...
- Output: knowledge/ui-designer-ui-concept-direction.md, knowledge/assets/ (for visual artifacts)
...
- Output: knowledge/ui-designer-ui-variant-exploration.md, knowledge/assets/ (for visual artifacts)
...
- Output: knowledge/ui-designer-visual-polish-and-consistency.md, knowledge/assets/ (for visual artifacts)
